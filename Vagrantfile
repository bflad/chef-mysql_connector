...
Vagrant.configure("2") do |config|
  ...
  config.vm.define :centos5 do |centos6|
    ...
    centos6.vm.hostname = "#{hostname}-centos-5"
  end
  ...
  config.vm.define :debian7 do |debian7|
    ...
    debian7.vm.hostname = "#{hostname}-debian-7"
  end
  ...
  config.vm.define :fedora18 do |fedora18|
    ...
    fedora18.vm.hostname = "#{hostname}-fedora-18"
  end
  ...
  config.vm.define :fedora19 do |fedora19|
    ...
    fedora19.vm.hostname = "#{hostname}-fedora-19"
  end
  ...
  config.vm.define :fedora20 do |fedora20|
    ...
    fedora20.vm.hostname = "#{hostname}-fedora-20"
  end
  ...
  config.vm.define :freebsd9 do |freebsd9|
    ...
    freebsd9.vm.hostname = "#{hostname}-freebsd-9"
  end
  ...
  config.vm.define :ubuntu1204 do |ubuntu1204|
    ...
    ubuntu1204.vm.hostname = "#{hostname}-ubuntu-1204"
  end
  ...
  config.vm.define :ubuntu1210 do |ubuntu1210|
    ...
    ubuntu1210.vm.hostname = "#{hostname}-ubuntu-1210"
  end
  ...
  config.vm.define :ubuntu1304 do |ubuntu1304|
    ...
    ubuntu1304.vm.hostname = "#{hostname}-ubuntu-1304"
  end
  ...
  config.vm.define :ubuntu1310 do |ubuntu1310|
    ...
    ubuntu1310.vm.hostname = "#{hostname}-ubuntu-1310"
  end
